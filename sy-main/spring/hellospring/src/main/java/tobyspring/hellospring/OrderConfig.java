...
import tobyspring.hellospring.order.OrderServiceTrasactionProxy;
...
public class OrderConfig {
    ...
    public OrderService orderService(OrderRepository orderRepository, PlatformTransactionManager transactionManager) {
        return new OrderServiceTrasactionProxy(new OrderServiceImpl(orderRepository), transactionManager);
    }
